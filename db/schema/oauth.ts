...
// Better Auth OAuth Provider 1.7.5 owns these records and token hashing.
export const oauthClient = club.table(
  "oauth_client",
  {
...
export const oauthResource = club.table("oauth_resource", {
  id: text("id").primaryKey(),
...
export const oauthClientResource = club.table(
...
export const oauthRefreshToken = club.table(
  "oauth_refresh_token",
  {
    id: text("id").primaryKey(),
    ...
    rotationReplayExpiresAt: instant("rotation_replay_expires_at"),
...
export const oauthAccessToken = club.table(
  "oauth_access_token",
  {
    id: text("id").primaryKey(),
    token: text("token").notNull().unique(),
...
export const oauthConsent = club.table(
  "oauth_consent",
  {
    id: text("id").primaryKey(),
    clientId: text("client_id")
...
export const oauthClientAssertion = club.table("oauth_client_assertion", {
  id: text("id").primaryKey(),
  expiresAt: instant("expires_at").notNull(),
});
